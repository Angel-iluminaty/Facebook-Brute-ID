...
def cover():
    print """
     ...
     """
    runntek(GL+"           Telegram'@Angeldelvillarteam ^_^...")
    time.sleep(1)
    print " "
    print RR+"  +============================================+"
    print GG+"  |¢â€€   HACK FACEBOOK By Angel Del Villar ¢â€¢|"
    print RR+"  +============================================+"
    print WW+"  |            Script BY: Angel Del Villar      |"
    print GG+"  |              Reza antes de usar            |"
    print WW+"  |           TELEGRAM: @Angeldelvillarteam    |"
    print Y+"  |             WhatsApp: Iluminaty school         |"
    print WW+"  |--------------------------------------------|"
...
passwordlist = str(raw_input(WW+" Ingrese el archivo de Contraseñas\033[95m[ pass.txt, pass1.txt, pass2.txt, pass3.txt ] \033[92;1m: "))
...
def kol():
    nok = raw_input("Editar lista de palabras cuk.? \033[96;1m[y/n]: ")
    if nok == "y":
...
def welcome():
        wel = GG+"""
No olvides visitar mi pagina de GitHub Donde encontraras mas información que te puede ayudar.... Gracias!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! \033[96;4mLa vida del programador\033[92;1m
       |_|
      """
        print wel
        print " "
